...
import { NSpace, NCard, NDivider, NH1, NH3,NP,NGrid,NGridItem,NButton,
  NModal,NForm,NFormItem,NInput,NDatePicker,useMessage,} from "naive-ui";
    ...
    <n-grid :cols="3" x-gap="24" y-gap="12">
        <n-grid-item v-for="lecture in lectureList" :key="lecture.id">
          <course-lecture
            ...
            :isAdmin="authStore.getUserInfo.user_type === 'User.Admin'"
          ></course-lecture>
        </n-grid-item>
      </n-grid>
      <n-divider v-if="authStore.getUserInfo.user_type === 'User.Admin'">
